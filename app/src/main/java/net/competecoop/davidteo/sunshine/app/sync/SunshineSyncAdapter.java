package net.competecoop.davidteo.sunshine.app.sync;
...
import net.competecoop.davidteo.sunshine.app.R;
import net.competecoop.davidteo.sunshine.app.Utility;
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // NtoficationCompatBuilder is a very convenient way to build backward-compatible
